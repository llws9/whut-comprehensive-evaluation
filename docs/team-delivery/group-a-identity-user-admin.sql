...
(1002, '2022010102', '李悦', 'liyue@whut.edu.cn', '13800000002', 'hash_2022010102', 'ACTIVE', '2026-05-01 08:05:00', '2026-05-18 09:22:00'),
(1003, '2022010103', '王澈', 'wangche@whut.edu.cn', '13800000003', 'hash_2022010103', 'ACTIVE', '2026-05-01 08:10:00', '2026-05-18 09:24:00'),
(1004, '2022010104', '周宁', 'zhouning@whut.edu.cn', '13800000004', 'hash_2022010104', 'ACTIVE', '2026-05-01 08:15:00', '2026-05-18 09:26:00'),
(1005, '2022010105', '陈曦', 'chenxi@whut.edu.cn', '13800000005', 'hash_2022010105', 'ACTIVE', '2026-05-01 08:20:00', '2026-05-18 09:28:00'),
(1006, '2022010106', '何川', 'hechuan@whut.edu.cn', '13800000006', 'hash_2022010106', 'LOCKED', '2026-05-01 08:25:00', '2026-05-17 21:18:00'),
(1007, '2022010107', '孙琪', 'sunqi@whut.edu.cn', '13800000007', 'hash_2022010107', 'ACTIVE', '2026-05-01 08:30:00', '2026-05-18 09:32:00'),
(1008, '2022010108', '赵航', 'zhaohang@whut.edu.cn', '13800000008', 'hash_2022010108', 'ACTIVE', '2026-05-01 08:35:00', '2026-05-18 09:34:00'),
(1009, '2022010109', '黄钰', 'huangyu@whut.edu.cn', '13800000009', 'hash_2022010109', 'DISABLED', '2026-05-01 08:40:00', '2026-05-15 17:40:00'),
(1010, 'T20260001', '辅导员刘敏', 'liumin@whut.edu.cn', '13900000010', 'hash_teacher_001', 'ACTIVE', '2026-05-01 08:45:00', '2026-05-18 10:00:00'),
(1011, 'T20260002', '审核老师郭峰', 'guofeng@whut.edu.cn', '13900000011', 'hash_teacher_002', 'ACTIVE', '2026-05-01 08:50:00', '2026-05-18 10:02:00'),
(1012, 'A20260001', '平台管理员孟凡', 'mengfan@whut.edu.cn', '13900000012', 'hash_admin_001', 'ACTIVE', '2026-05-01 08:55:00', '2026-05-18 10:04:00');
...
(5001, 'student.home.view', '查看学生首页', 'student', 'ACTIVE', '2026-05-01 09:30:00'),
(5002, 'student.application.view', '查看申请页', 'student', 'ACTIVE', '2026-05-01 09:30:01'),
(5003, 'student.history.view', '查看申请记录', 'student', 'ACTIVE', '2026-05-01 09:30:02'),
(5004, 'student.grades.view', '查看成绩页', 'student', 'ACTIVE', '2026-05-01 09:30:03'),
(5005, 'student.attachments.view', '查看附件页', 'student', 'ACTIVE', '2026-05-01 09:30:04'),
(5006, 'manage.dashboard.view', '查看工作台', 'manage', 'ACTIVE', '2026-05-01 09:30:05'),
...
(6005, 4001, 5005, '2026-05-01 09:40:04'),
(6006, 4002, 5007, '2026-05-01 09:40:05'),
(6007, 4003, 5006, '2026-05-01 09:40:06'),
(6008, 4003, 5007, '2026-05-01 09:40:07'),
(6009, 4004, 5007, '2026-05-01 09:40:08'),
(6010, 4005, 5006, '2026-05-01 09:40:09'),
...
(8001, 7001, 'student.home.view', 'SELF', NULL, NULL, NULL, JSON_OBJECT('owner', 'self'), 100, 'ACTIVE', '2026-05-01 10:20:00'),
(8002, 7002, 'student.application.view', 'SELF', NULL, NULL, NULL, JSON_OBJECT('owner', 'self'), 100, 'ACTIVE', '2026-05-01 10:20:01'),
(8003, 7003, 'student.history.view', 'SELF', NULL, NULL, NULL, JSON_OBJECT('owner', 'self'), 100, 'ACTIVE', '2026-05-01 10:20:02'),
(8004, 7004, 'student.grades.view', 'SELF', NULL, NULL, NULL, JSON_OBJECT('owner', 'self'), 100, 'ACTIVE', '2026-05-01 10:20:03'),
(8005, 7005, 'student.attachments.view', 'SELF', NULL, NULL, NULL, JSON_OBJECT('owner', 'self'), 100, 'ACTIVE', '2026-05-01 10:20:04'),
(8006, 7006, 'student.application.view', 'SELF', NULL, 'LABOR', NULL, JSON_OBJECT('allowDraft', true), 95, 'ACTIVE', '2026-05-01 10:20:05'),
(8007, 7007, 'student.history.view', 'SELF', NULL, 'SPORTS', NULL, JSON_OBJECT('allowReviewTrace', true), 95, 'ACTIVE', '2026-05-01 10:20:06'),
(8008, 7008, 'student.grades.view', 'SELF', NULL, NULL, NULL, JSON_OBJECT('allowCompare', false), 95, 'ACTIVE', '2026-05-01 10:20:07'),
...
(9002, 1002, 'token-1002-a', '10.20.1.2', 'Chrome/136 macOS', '2026-05-19 08:10:00', NULL, 'ACTIVE', '2026-05-18 08:10:00'),
(9003, 1003, 'token-1003-a', '10.20.1.3', 'Safari/17 macOS', '2026-05-19 08:20:00', NULL, 'ACTIVE', '2026-05-18 08:20:00'),
(9004, 1004, 'token-1004-a', '10.20.1.4', 'Chrome/136 Windows', '2026-05-19 08:30:00', NULL, 'ACTIVE', '2026-05-18 08:30:00'),
(9005, 1005, 'token-1005-a', '10.20.1.5', 'Edge/135 Windows', '2026-05-19 08:40:00', NULL, 'ACTIVE', '2026-05-18 08:40:00'),
(9006, 1006, 'token-1006-a', '10.20.1.6', 'Chrome/136 Android', '2026-05-17 08:50:00', NULL, 'EXPIRED', '2026-05-16 08:50:00'),
(9007, 1007, 'token-1007-a', '10.20.1.7', 'Chrome/136 iOS', '2026-05-19 09:00:00', NULL, 'ACTIVE', '2026-05-18 09:00:00'),
(9008, 1008, 'token-1008-a', '10.20.1.8', 'Safari/17 iPadOS', '2026-05-19 09:10:00', NULL, 'ACTIVE', '2026-05-18 09:10:00'),
(9009, 1009, 'token-1009-a', '10.20.1.9', 'Chrome/136 Linux', '2026-05-18 09:20:00', '2026-05-18 09:25:00', 'REVOKED', '2026-05-18 07:20:00'),
(9010, 1010, 'token-1010-a', '10.20.2.10', 'Chrome/136 macOS', '2026-05-19 09:30:00', NULL, 'ACTIVE', '2026-05-18 09:30:00'),
(9011, 1011, 'token-1011-a', '10.20.2.11', 'Chrome/136 macOS', '2026-05-19 09:40:00', NULL, 'ACTIVE', '2026-05-18 09:40:00'),
(9012, 1012, 'token-1012-a', '10.20.2.12', 'Chrome/136 macOS', '2026-05-19 09:50:00', NULL, 'ACTIVE', '2026-05-18 09:50:00');

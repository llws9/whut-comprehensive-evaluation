...
class IamSessionDOTest {

    @Test
    void shouldUseAssignIdStrategyForIamSessionPrimaryKey() throws NoSuchFieldException {
        Field idField = IamSessionDO.class.getDeclaredField("id");

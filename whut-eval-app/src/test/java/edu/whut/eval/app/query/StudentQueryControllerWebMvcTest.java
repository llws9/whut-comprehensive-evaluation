...
@WebMvcTest(controllers = StudentQueryController.class)
@AutoConfigureMockMvc(addFilters = false)
@ContextConfiguration(classes = StudentQueryControllerWebMvcTest.TestApplication.class)
@Import({
        StudentQueryController.class,
        GlobalExceptionHandler.class
})
class StudentQueryControllerWebMvcTest {
    ...
    void shouldReturnPagedApplications() throws Exception {
        ...
        mockMvc.perform(get("/api/student/query/applications")
                        .param("pageNo", "1")
                        .param("pageSize", "10"))
    ...
    void shouldReturnPagedScores() throws Exception {
        ...
        mockMvc.perform(get("/api/student/query/scores")
                        .param("pageNo", "1")
                        .param("pageSize", "10"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
